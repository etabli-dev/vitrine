...
| Canal | App |
|-------|-----|
| Android (APK) — [GitHub Releases](https://github.com/etabli-dev/etabli-vitrine/releases) | Vitrine — **version de développement** (embarque des runtimes WASM précompilés) |
| App Store (iOS) · Google Play (Android) | prévu — pas encore disponible |
| F-Droid — dépôt propre à Établi | prévu — pas encore disponible |
